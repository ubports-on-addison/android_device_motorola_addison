...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/ubuntu/70-addison.rules:system/halium/lib/udev/rules.d/70-android.rules \
    $(LOCAL_PATH)/ubuntu/ubuntu-touch-session-android.conf:system/halium/etc/ubuntu-touch-session.d/android.conf \
